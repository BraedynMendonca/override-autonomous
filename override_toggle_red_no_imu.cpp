// VEXcode V5 / Voltage: RED alliance toggle-only autonomous (NO IMU).
// Red: one forward press/retreat cycle; no turns or mechanism commands.
// Entry point: overrideToggleOnlyRedNoImu15().
...
namespace override_toggle_red_no_imu {
...
void overrideToggleOnlyRedNoImu15() { override_toggle_red_no_imu::run(1); }
