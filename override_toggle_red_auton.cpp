// VEXcode V5 / Voltage: RED alliance toggle-only autonomous.
// Red: one forward press/retreat cycle; no turns or mechanism commands.
// Entry point: overrideToggleOnlyRed15().
...
void overrideToggleOnlyRed15() { override_toggle_red::run(1); }
